...
const items = [
        { icon: 'fab fa-instagram', link: 'https://instagram.com/wotzshu' },
    { icon: 'fab fa-youtube', link: 'https://youtube.com/xxx' },
    { icon: 'fab fa-github', link: 'https://github.com/wotzshu' }
  ]

const navItems = [
    { icon: 'fal fa-home', active: 'fa fa-home', label: 'Ana Sayfa', href: '/' },
    { icon: 'fal fa-phone', active: 'fa fa-phone', label: 'Bana Ulaş', href: '/contact' }
]
